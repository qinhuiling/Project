...
import com.bwie.asus.exercise.adapter.RecyAdapter;
import com.bwie.asus.exercise.banner.BannerImageLoader;
import com.bwie.asus.exercise.bean.Bean;
import com.bwie.asus.exercise.net.DialogUtils;
        ...
        Utils.download().getBean().subscribeOn(Schedulers.io())
                ...
                .subscribe(new Observer<Bean>() {
                    ...
                    public void onNext(Bean bean) {
                        ...
                        adapter = new RecyAdapter(Main2Activity.this, data);
                        ...
                        adapter.setOnItemClickListener(new RecyAdapter.OnItemClickListener() {
                            ...
                            public void onItemClick(int position) {
                                ...
                                DialogUtils.showDialog(Main2Activity.this);
